...
import externalLink from "../../assets/image/projects/external-link.svg"
      ...
      <div className="projects">
        ...
        <div className="project">
          <header>
            ...
            <div className="project-links">
              <a href="https://angelskinbyangela.com/" target="_blank" rel="noreferrer">
          ...
          <div className="body">
            <h3>Angel Skin</h3>
            <p>
              A website I made for an Esthetician.
            </p>
          </div>
          <footer>
        ...
        <div className="project">
          <header>
            <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " stroke-width="1" stroke-linecap="round" stroke-linejoin="round" ><title>Folder</title><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path></svg>
            <div className="project-links">
              <a href="https://littleluxuryitems.co/" target="_blank" rel="noreferrer">
                <img src={externalLink} alt="Visit site" />
              </a>
            </div>
          </header>
          <div className="body">
            <h3>Little Luxury Items</h3>
            <p>
              Little Luxury Items, your destination for unique and innovative products. An E-Commerce Store Made by Shopify
            </p>
          </div>
          <footer>
            <ul className="tech-list">
